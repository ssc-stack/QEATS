...
then
  ...
  echo $'\e[32;1mPlease read this FAQ for more details - https:
fi
...
then
    git clone git@gitlab.shashank.do:me_qeats_shared/qeats_shared_resources.git $QEATS_SHARED_RESOURCES
else
